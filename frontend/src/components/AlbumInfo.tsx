        ...
        try {
            ...
            if (response.success) {
                if (response.already_exists)
                    toast.info("Cover already downloaded — skipped");
                else
